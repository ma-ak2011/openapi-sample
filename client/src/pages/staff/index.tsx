    ...
    <>
      {deleteTarget !== undefined && (
        <ConfirmDialog
          ...
          onClickCancel={() =>
            setViewState({ ...viewState, confirmDeleteId: null })
          }
        />
      )}
      <Head>
                      ...
                      {sortedStaffs.map((s) => {
                        return (
                          ...
                          >
                            ...
                            <TableCell align="left">{s.firstName}</TableCell>
                            <TableCell align="left">
                              {format(s.birthDate, 'yyyy-MM-dd')}
                            </TableCell>
                            ...
                            <TableCell align="right">
                              <Tooltip title="編集" placement="top" arrow>
                                <IconButton
                                  ...
                                  onClick={(_e) =>
                                    router.push(
                                      pagesPath.staff._sid(s.id).edit.$url(),
                                    )
                                  }
                                >
                                  <Edit />
